//Amol Shah | Assignment 8 | CS330 | 05/04/16
/********************************************
Use: Server program that continues listening until terminated.
Process client request as path beyond root and shows directories, 
index file if present or opens specified file in path.
Usage:
Example launch command usage: ./a.out 9000 ~/
Example client side connect: telnet localhost 9000
********************************************/
